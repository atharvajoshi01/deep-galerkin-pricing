...
```
European Call (K=100, r=0.05, sigma=0.2, T=1.0)
------------------------------------------------
...
cd deep-galerkin-pricing/deep_galerkin_project
python -m venv venv
...
- [Getting Started Guide](deep_galerkin_project/GETTING_STARTED.md) - Complete beginner tutorial
- [Cloud Deployment](deep_galerkin_project/docs/DEPLOYMENT.md) - Deploy to AWS, GCP, or Azure
- [Mathematical Background](deep_galerkin_project/docs/math_black_scholes.md) - PDE theory and derivations
- [DGM Architecture](deep_galerkin_project/docs/dgm_architecture.md) - Neural network design
- [Project Summary](deep_galerkin_project/PROJECT_SUMMARY.md) - Technical overview
...
MIT License - see [LICENSE](deep_galerkin_project/LICENSE)
